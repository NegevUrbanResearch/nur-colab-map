-- Palette v4: remap v3 primaries to more perceptually distinct hues; refresh CHECK + RPC palette.
...
SET display_color = CASE upper(btrim(display_color))
    ...
    WHEN '#DB2777' THEN '#EC4899'
    WHEN '#F43F5E' THEN '#F43F5E'
    WHEN '#7C2D12' THEN '#92400C'
    WHEN '#1E293B' THEN '#3F3F46'
    WHEN '#854D0E' THEN '#B45309'
    WHEN '#14532D' THEN '#14532D'
    WHEN '#9D174D' THEN '#9F1239'
